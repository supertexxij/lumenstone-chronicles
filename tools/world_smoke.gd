...
func _finish():
	...
	print("CHESTNUT_TOAD_SRC", '"chestnut_toad"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("FESTIVAL_SRC", "play_festival_decade_sparkle" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("FOUNTAIN_MIST_SRC", "FountainPlazaMist" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("SOFT_AGGRO_COMBO_SRC", "Wave 50: clearer soft-aggro name+countdown combo" in FileAccess.get_file_as_string("res://scripts/world/enemy.gd"))
	...
	print("MASTERY_WEEK_TOAST_SRC", "Quest complete ·" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd") or "Quest mastered · Week" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	...
	print("VERSION_156_SRC", 'config/version="1.56.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.57.0"' in FileAccess.get_file_as_string("res://project.godot"))




	print("CHERRY_CHINCHILLA_SRC", '"cherry_chinchilla"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("REED_SWAY_SRC", "_update_reed_sway" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("READY_FLASH_SRC", "Wave 57: clearer Ready flash color" in FileAccess.get_file_as_string("res://scripts/ui/hud.gd"))
	...
	print("VERSION_158_SRC", 'config/version="1.58.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.59.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.60.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.61.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.62.0"' in FileAccess.get_file_as_string("res://project.godot"))
	...
	print("VERSION_159_SRC", 'config/version="1.59.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.60.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.61.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.62.0"' in FileAccess.get_file_as_string("res://project.godot"))
	...
	print("VERSION_160_SRC", 'config/version="1.60.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.61.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.62.0"' in FileAccess.get_file_as_string("res://project.godot"))



	print("GRAPE_GECKO_SRC", '"grape_gecko"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("WILLOW_SWAY_SRC", "_update_willow_sway" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("FOOD_EMPTY_H_SRC", "press H for Fountain to refill" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("UNEQUIP_ALL_SRC", "unequip_all_slots" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("WAVE61_TOAST_SRC", "maybe_wave_61_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_161_SRC", 'config/version="1.61.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.62.0"' in FileAccess.get_file_as_string("res://project.godot"))



	print("APRICOT_ARMADILLO_SRC", '"apricot_armadillo"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("FERN_SWAY_SRC", "_update_fern_sway" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("TRAVEL_FADE_NAME_SRC", "SoftTravelFadeLabel" in FileAccess.get_file_as_string("res://scripts/ui/main.gd"))
	...
	print("VERSION_162_SRC", 'config/version="1.62.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.63.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.65.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.66.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.67.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.68.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("BLUEBERRY_BUNNY_SRC", '"blueberry_bunny"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("HEATHER_SWAY_SRC", "_update_heather_sway" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	...
	print("VERSION_163_SRC", 'config/version="1.63.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.65.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.66.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.67.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.68.0"' in FileAccess.get_file_as_string("res://project.godot"))
	...
	print("AGGRO_DEF_RING_SRC", "Wave 64: clearer soft-aggro ring when armor Def high" in FileAccess.get_file_as_string("res://scripts/world/enemy.gd"))
	...
	print("VERSION_164_SRC", 'config/version="1.64.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.65.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.66.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.67.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.68.0"' in FileAccess.get_file_as_string("res://project.godot"))
	...
	print("VERSION_165_SRC", 'config/version="1.65.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.66.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.67.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.68.0"' in FileAccess.get_file_as_string("res://project.godot"))
	...
	print("ARRIVAL_SHORT_SRC", "_travel_landmark_short" in FileAccess.get_file_as_string("res://scripts/ui/main.gd"))
	print("VICTORY_SPARKLE_SRC", "Wave 66: softer richer victory sparkle polish" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	...
	print("VERSION_167_SRC", 'config/version="1.67.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.68.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.69.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.70.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.71.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.72.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.73.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.74.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("GUAVA_GOAT_SRC", '"guava_goat"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("WILLOW_LEAVES_SRC", "WillowBendLeafDrift" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("NEAR_MISS_TITLE_SRC", "short_title" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("FOUNTAIN_CHIME_SRC", "play_fountain_rest_chime" in FileAccess.get_file_as_string("res://scripts/autoload/audio_bus.gd"))
	print("UNEQUIP_COUNT_SRC", "Confirm? · %d" in FileAccess.get_file_as_string("res://scripts/ui/inventory_panel.gd"))
	print("YEAR_MASTERY_GOLD_SRC", "_year_chip_last_mastery" in FileAccess.get_file_as_string("res://scripts/ui/hud.gd"))
	print("WAVE68_TOAST_SRC", "maybe_wave_68_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_168_SRC", 'config/version="1.68.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.69.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.70.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.71.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.72.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.73.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.74.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("KIWI_KOALA_SRC", '"kiwi_koala"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("FERN_FRONDS_SRC", "FernDellFrondDrift" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("LANDMARK_PACES_CHIP_SRC", "landmark_dist" in FileAccess.get_file_as_string("res://scripts/world/world.gd") and "✦ %s · ~%d paces" in FileAccess.get_file_as_string("res://scripts/ui/hud.gd"))
	print("CANOPY_DRIP_POLISH_SRC", "Wave 69: soft rain-canopy drip polish" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("MASTERED_FILTER_COUNT_SRC", "Mastered ★ · %d" in FileAccess.get_file_as_string("res://scripts/ui/journal_panel.gd"))
	print("SAVE_CHIP_PULSE_SRC", "_on_game_saved_pulse" in FileAccess.get_file_as_string("res://scripts/ui/hud.gd"))
	print("WAVE69_TOAST_SRC", "maybe_wave_69_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_169_SRC", 'config/version="1.69.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.70.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.71.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.72.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.73.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.74.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("MANGO_MONGOOSE_SRC", '"mango_mongoose"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("HEATHER_BLOOMS_SRC", "HeatherHeathBloomDrift" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("HEATHER_DUSK_SWAY_SRC", "Wave 70: soft heather sway reads stronger at dusk" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("PARENT_MASTERY_STARS_SRC", "_mastery_progress_bar" in FileAccess.get_file_as_string("res://scripts/ui/parent_panel.gd"))
	print("WAVE70_TOAST_SRC", "maybe_wave_70_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_170_SRC", 'config/version="1.70.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.71.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.72.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.73.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.74.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("PAPAYA_PANDA_SRC", '"papaya_panda"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("THISTLE_BLOOMS_SRC", "ThistleRiseBloomDrift" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("THISTLE_DUSK_SWAY_SRC", "Wave 71: soft thistle sway reads stronger at dusk" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("DAILY_CHECKPOINT_CLEAR_SRC", "Daily checkpoint · open Parent" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("BREAD_LOW_FLASH_SRC", "_food_bread_low" in FileAccess.get_file_as_string("res://scripts/ui/hud.gd"))
	print("WAVE71_TOAST_SRC", "maybe_wave_71_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_171_SRC", 'config/version="1.71.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.72.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.73.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.74.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))



	print("COCONUT_CRAB_SRC", '"coconut_crab"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("MAPLE_DUSK_LEAVES_SRC", "MapleCopseDuskLeafDrift" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("MAPLE_DUSK_BOOST_SRC", "Wave 72: denser Maple Copse leaf fall reads stronger at dusk" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("EDGE_FOG_POLISH_SRC", "Wave 72: soft edge-fog banks polish" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("FOUNTAIN_REST_CLEAR_SRC", "Fountain rest · HP returning gently" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("JOURNAL_OPEN_WEEKS_SRC", "_format_open_quest_weeks" in FileAccess.get_file_as_string("res://scripts/ui/journal_panel.gd"))
	print("WAVE72_TOAST_SRC", "maybe_wave_72_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_172_SRC", 'config/version="1.72.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.73.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.74.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("LIME_LLAMA_SRC", '"lime_llama"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("AMBER_GLOW_MOTES_SRC", "AmberKnollGlowMotes" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("AMBER_GLOW_POLISH_SRC", "Wave 73: soft Amber Knoll amber-glow polish at dusk" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("BROOK_MURMUR_POLISH_SRC", "Wave 73: soft brook murmur polish" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("PUDDLE_RIPPLE_POLISH_SRC", "Wave 73: soft puddle ripple polish" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("QUEST_COMPLETE_TITLE_SRC", "Quest complete ·" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("PARENT_EMPTY_WARMER_SRC", "A quiet week for now" in FileAccess.get_file_as_string("res://scripts/ui/parent_panel.gd"))
	print("BAG_STACK_TYPE_HINT_SRC", "🍞 stack" in FileAccess.get_file_as_string("res://scripts/ui/inventory_panel.gd"))
	print("WAVE73_TOAST_SRC", "maybe_wave_73_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_173_SRC", 'config/version="1.73.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.74.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))



	print("MELON_MOOSE_SRC", '"melon_moose"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("CEDAR_NEEDLE_DRIFT_SRC", "CedarHollowNeedleDrift" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("PLAZA_LANTERN_SYNC_SRC", "Wave 74: plaza dusk lantern sync polish" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("FOE_VICTORY_SPARKLE_SRC", "_play_foe_victory_sparkle" in FileAccess.get_file_as_string("res://scripts/world/enemy.gd"))
	print("YEAR_CHIP_WEEK_SRC", "week %d of 36" in FileAccess.get_file_as_string("res://scripts/ui/hud.gd"))
	print("TRAVEL_NEAR_PULSE_SRC", "_tick_travel_near_pulse" in FileAccess.get_file_as_string("res://scripts/ui/main.gd"))
	print("WAVE74_TOAST_SRC", "maybe_wave_74_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_174_SRC", 'config/version="1.74.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("QUINCE_QUOKKA_SRC", '"quince_quokka"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("STONE_ARCH_DUST_SRC", "StoneArchLimestoneDust" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("WIND_LEAF_POLISH_SRC", "Wave 75 soft wind leaf particles polish" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("FIRST_DISCOVERY_TOAST_SRC", "✦ First discovery ·" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("JOURNAL_MASTERED_STICKY_COUNT_SRC", "Mastered this week sticky ·" in FileAccess.get_file_as_string("res://scripts/ui/journal_panel.gd"))
	print("PARENT_OLDEST_HELP_SRC", "oldest attempt first" in FileAccess.get_file_as_string("res://scripts/ui/parent_panel.gd"))
	print("WAVE75_TOAST_SRC", "maybe_wave_75_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_175_SRC", 'config/version="1.75.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("WATERMELON_WALLABY_SRC", '"watermelon_wallaby"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("CROSS_LANTERN_MOTHS_SRC", "QuietCrossLanternMoths" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("CRICKET_HUSH_POLISH_SRC", "Wave 76 soft night cricket hush polish" in FileAccess.get_file_as_string("res://scripts/autoload/audio_bus.gd") or "Wave 43/76: soft night cricket hush" in FileAccess.get_file_as_string("res://scripts/autoload/audio_bus.gd"))
	print("DEF_EQUIP_FLASH_SRC", "_def_equip_flash_id" in FileAccess.get_file_as_string("res://scripts/ui/inventory_panel.gd"))
	print("FOES_UP_CHIP_SRC", "Foes · %d ↑" in FileAccess.get_file_as_string("res://scripts/ui/hud.gd"))
	print("WAVE76_TOAST_SRC", "maybe_wave_76_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_176_SRC", 'config/version="1.76.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))


	print("HONEYDEW_HAMSTER_SRC", '"honeydew_hamster"' in FileAccess.get_file_as_string("res://data/enemies.json"))
	print("BIRCH_FIREFLY_DENSE_SRC", "Wave 66/77: soft birch-rest firefly denser wink" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("CAMPFIRE_POLISH_SRC", "Wave 77: soft campfire glow polish" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("SOFT_TRAVEL_ARRIVAL_SRC", "Arrived · Soft travel ·" in FileAccess.get_file_as_string("res://scripts/ui/main.gd"))
	print("FAV_CHIP_PACES_SRC", "Wave 77: ★ fav chip shows paces to fav" in FileAccess.get_file_as_string("res://scripts/ui/hud.gd"))
	print("WAVE77_TOAST_SRC", "maybe_wave_77_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_177_SRC", 'config/version="1.77.0"' in FileAccess.get_file_as_string("res://project.godot") or 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))

	print("PLAZA_COBBLE_SRC", "PlazaCobble" in FileAccess.get_file_as_string("res://scripts/world/world.gd"))
	print("HUMANOID_FACE_SRC", "LEye" in FileAccess.get_file_as_string("res://scripts/characters/humanoid_builder.gd"))
	print("PARENT_PIN_LOCK_SRC", "do NOT open the dashboard on a wrong PIN" in FileAccess.get_file_as_string("res://scripts/ui/parent_panel.gd"))
	print("REFINE_178_TOAST_SRC", "maybe_refine_178_toast" in FileAccess.get_file_as_string("res://scripts/autoload/game_state.gd"))
	print("VERSION_178_SRC", 'config/version="1.78.0"' in FileAccess.get_file_as_string("res://project.godot"))
