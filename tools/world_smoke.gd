...
func _finish():
	...
	print("PLAZA_FLAG_SRC", "PlazaFlag" in _src("res://scripts/world/world.gd") and "YardCart" in _src("res://scripts/world/world.gd"))
	print("LANDMARK_PLAZA_SRC", "LandmarkPlazaGlade" in _src("res://scripts/world/world.gd") and "_dress_world_finish" in _src("res://scripts/world/world.gd"))
	print("DAY_FILL_SRC", "DayFill" in _src("res://scripts/world/world.gd"))
	print("HUMANOID_CLOTHES_SRC", "Collar" in _src("res://scripts/characters/humanoid_builder.gd") and "Hem" in _src("res://scripts/characters/humanoid_builder.gd"))
