...
func _ready() -> void:
	...
	_ensure_food_lbl()
	_ensure_year_chip()
	hint_lbl.text = "Click · WASD · Zoom · Q/E · I/J/C · V food · M mute · R weather · T travel · F talk · H fountain · N glade · B ridge · G garden · L lookout · K mill · O hollow · P willow · Y reed · U cross · X arch · Z knoll · 6 birch · 7 fern · 8 heather · 1–5 halls"
	_refresh_mute_label()
